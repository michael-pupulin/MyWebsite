...
function $s_Lexample_Hello__main__AT__V(args) {
  $m_Lexample_Hello$()
}
/** @constructor */
function $c_Lexample_Hello$() {
  this.Lexample_Hello$__f_i = 0;
  this.Lexample_Hello$__f_paths = null;
  this.Lexample_Hello$__f_caps = null;
  this.Lexample_Hello$__f_j = 0;
  this.Lexample_Hello$__f_workpics = null;
  this.Lexample_Hello$__f_workcaps = null;
  $n_Lexample_Hello$ = this;
  this.Lexample_Hello$__f_i = 0;
  this.Lexample_Hello$__f_paths = new ($d_T.getArrayOf().constr)(["hqp.jpg", "cotty.jpeg", "camp.jpeg", "golf.JPG", "surf.jpg", "sanf.JPG", "simba.jpg", "eddie.jpg"]);
  this.Lexample_Hello$__f_caps = new ($d_T.getArrayOf().constr)(["That's me.", "My friends !", "My girlfriend, Emily, and I while camping &#127957", "Playing some golf &#9971 ", "Surfing for the first time &#127940", "Trip to California &#128526", "My dog Simba.", "My dog Eddie."]);
  this.Lexample_Hello$__f_j = 0;
  this.Lexample_Hello$__f_workpics = new ($d_T.getArrayOf().constr)(["eb.png", "onf.png", "article.png"]);
  this.Lexample_Hello$__f_workcaps = new ($d_T.getArrayOf().constr)(["My EasyBlight app, made with R and R Shiny.", "What subscribers see when a new post has been published to ONfruit.", "A screenshot of the article I wrote for Orchard Network Newsletter."])
}
...
$c_Lexample_Hello$.prototype.doClickStuff__V = (function() {
  this.Lexample_Hello$__f_i = ((1 + this.Lexample_Hello$__f_i) | 0);
  var image = document.getElementById("myimage");
  var cap = document.getElementById("caption");
  if ((this.Lexample_Hello$__f_i > (((-1) + this.Lexample_Hello$__f_paths.u.length) | 0))) {
    this.Lexample_Hello$__f_i = 0
  };
  var xs = this.Lexample_Hello$__f_paths.get(this.Lexample_Hello$__f_i);
  var x = ("<img id=\"myimage\" class=\"slide\" src=\"./images/" + xs);
  image.outerHTML = (x + "\" />");
  cap.innerHTML = this.Lexample_Hello$__f_caps.get(this.Lexample_Hello$__f_i);
  var this$8 = $m_s_Console$();
  var this$9 = this$8.out__Ljava_io_PrintStream();
  this$9.java$lang$JSConsoleBasedPrintStream$$printString__T__V("button clicked\n")
});
$c_Lexample_Hello$.prototype.workslides__V = (function() {
  this.Lexample_Hello$__f_j = ((1 + this.Lexample_Hello$__f_j) | 0);
  var image = document.getElementById("workimg");
  var cap = document.getElementById("workcaption");
  if ((this.Lexample_Hello$__f_j > (((-1) + this.Lexample_Hello$__f_workpics.u.length) | 0))) {
    this.Lexample_Hello$__f_j = 0
  };
  var xs = this.Lexample_Hello$__f_workpics.get(this.Lexample_Hello$__f_j);
  var x = ("<img id=\"workimg\" class=\"workslide\" src=\"./images/" + xs);
  image.outerHTML = (x + "\" />");
  cap.innerHTML = this.Lexample_Hello$__f_workcaps.get(this.Lexample_Hello$__f_j);
  var this$8 = $m_s_Console$();
  var this$9 = this$8.out__Ljava_io_PrintStream();
  this$9.java$lang$JSConsoleBasedPrintStream$$printString__T__V("button clicked\n")
});
...
$d_J.zero = $L0;
workslides = (function() {
  $m_Lexample_Hello$().workslides__V()
});
doClickStuff = (function() {
  $m_Lexample_Hello$().doClickStuff__V()
});
$s_Lexample_Hello__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
